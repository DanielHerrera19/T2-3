...
using T2_3.EJERCICIO3;

namespace T2_3.EJERCICIO_3
{
    public class MenuConsola
    {
        ...
        private static int getsuma()
        {
            ...
            return Calculos.sumar(numero1, numero2);
        }
        private static int getResta()
        {
            int numero1 = Operaciones.getEntero("Numero 1: ");
            int numero2 = Operaciones.getEntero("Numero 2: ");
            return Calculos.restar(numero1, numero2);
        }
        ...
        {
            string opciondeTexto = Console.ReadLine();
            return int.Parse(opciondeTexto);
        }
    }
}